...
@section('title', 'POS | Restock Reprice')
        ...
        <article class="resume-wrapper mx-auto theme-bg-light p-3 mb-5 my-5 shadow-lg">
            ...
            <div class="resume-header">
                <div class="row align-items-center">
                    <div class="resume-title col-12 col-md-6 col-lg-8 col-xl-10">
                        <h2 class="resume-name mb-0 text-uppercase">Products Pricing</h2>
                    </div><!--//resume-title-->
                    <div class="resume-contact col-12 col-md-6 col-lg-4 col-xl-2">
                        <a href="{{ route('product_price_history') }}" class="btn btn-success">History</a>
                    </div><!--//resume-contact-->
                </div><!--//row-->
            ...
            <div class="resume-intro py-3">
                ...
                <div class="col-md-12 form_field_outer p-0">
                    <form action="store_price_product" method="POST" autocomplete="off">
                        @csrf
                            ...
                            if(data.product_name === 'No_data'){
                                ...
                                document.querySelector('#contentProduct').insertAdjacentHTML(
                                    ...
                                    `<div class="row mb-2">
                                        ...
                                        <div class="form-group col-2">
                                            <input type="number" min="0" step="0.01" value="${data.cost}" class="form-control bg-white" name="cost[]" required>
                                        </div>
                                        <div class="form-group col-2">
                                            <input type="number" min="0" step="0.01" value="${data.price}" class="form-control bg-white" name="price[]" required>
                                        </div> 
