...
@section('title', 'POS | Products Restock History')
            ...
            <div class="resume-header">
                <div class="row align-items-center">
                    <div class="resume-title col-12 col-md-6 col-lg-8 col-xl-10">
                        <h2 class="resume-name mb-0 text-uppercase" style="padding-left: 2rem;">Products Restock History</h2>
                    </div><!--//resume-title-->
                        ...
                        <tbody>
                            @forelse ($products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="edit_restock_history/{{ $product->id }}" title="Edit" style="padding: 0 7px 0 7px; height: 28px;"><i class="fas fa-edit"></i></a>
