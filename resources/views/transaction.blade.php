            ...
            <div class="resume-header">
                <div class="row align-items-center">
                    <div class="resume-title col-12 col-md-6 col-lg-8 col-xl-10">
                        <h2 class="resume-name mb-0 text-uppercase" style="padding-left: 4rem;">Enter Transactions</h2>
                    </div><!--//resume-title-->
                            ...
                            document.querySelector('#contentProduct').insertAdjacentHTML(
                                ...
                                `<div class="row mb-2"> 
                                    <div class="form-group col-6">
                                        <select class="form-control bg-white" name="product_id[]"><option value="${data.product_id}" selected>${data.brand} - ${data.product_description}</option></select>
                                    </div>
                                    <div class="form-group col-1">
                                        <select class="form-control bg-white px-0 stock" style="text-align: center;"><option selected>${data.stock}</option></select>
                                    </div>
                                    <div class="form-group col-1">
