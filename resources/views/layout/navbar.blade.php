<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('dashboard') }}"><strong>{{ \App\Models\ShopSettings::find(1)->text_logo}}</strong> </a>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                ...
                " href="{{ route('add_transaction') }}">Transactions</a>
            </li>
            <li class="nav-item">
                <a class="nav-link 
                ...
                " href="{{ route('receivables_list') }}">Receivables</a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('suppliers_list') ? 'active' : '' }}" href="{{ route('suppliers_list') }}">Suppliers</a>
            </li>
