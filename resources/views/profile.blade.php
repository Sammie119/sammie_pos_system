...
@section('title', 'POS | User Profile')
    ...
    <div class="container px-3 px-lg-5">
        <article class="resume-wrapper mx-auto theme-bg-light p-2 mb-5 my-5 shadow-lg">
            ...
            <div class="resume-header">
                <div class="row align-items-center">
                    <div class="resume-title col-12 col-md-6 col-lg-8 col-xl-9">
                        <h2 class="resume-name mb-0 text-uppercase" style="padding-left: 4rem;">User Profile</h2>
                    </div><!--//resume-title-->
                </div><!--//row-->
            ...
            <div class="resume-intro py-3" style="padding: 4rem 4rem;">
                <form action="{{ (Auth()->user()->role == 1) ? route('profile_post') : route('profile_post_user') }}" method="POST" autocomplete="off" class="row g-3">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="username" value="{{ $user->username }}" class="form-control" id="inputCity">
